...
from recommendation_engine.app.recommendation.types import TRecommendationSubSequences, TProductIdsOrderedAndUnique


class RecommendationModel(BaseModel):
    id: PyObjectId | None = Field(alias="_id", default=None)

    fingerprint: str = Field(..., description="SHA1 hash of the original sequence (unique)")
